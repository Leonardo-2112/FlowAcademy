...
$base = '../';
$titulo = 'Cadastro de Administrativo';
$ativo = 'cadastro_administrativo';
$erro = '';
$perfilAlvo = 'administrativo';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && post('acao') === 'salvar') {
    try {
        ...
        registrarLog('Cadastrou usuario de administrativo');
        flash('success', 'Usuario cadastrado com sucesso.');
        redirecionar('cadastro_administrativo.php');
...
<section class="page-heading"><div><span class="eyebrow">Admin</span><h1>Cadastro Administrativo</h1><p>Cria o usuario de acesso para funcionarios administrativos.</p></div></section>
...
<section class="panel">
  <div class="panel-header"><h2>Funcionarios administrativos cadastrados</h2></div>
